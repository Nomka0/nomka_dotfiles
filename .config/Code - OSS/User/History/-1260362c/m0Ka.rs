...
//retornan variables y esas variables retornadas son asignadasa a s1 y s2, entonces ahora ellas son las propietarias
//de esas variables retornadas, respectivamente.
