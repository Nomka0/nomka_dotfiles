fn main() {
  ...
  let mut user2 = Usuario {
    ...
    sexo: 'M',
    correo: String::from("correo@carlos.com"),
    id: 1234578,
  ...
  //como lo dice el nombre de la sintaxis, queremos actualizar el usuario, entonces el anterior queda deprecated,
  //obsoleto, no tendría sentido volverlo a usar porque lo actualizamos, y no se puede volver a usar de todos modos.
